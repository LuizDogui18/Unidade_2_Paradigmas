...
public class GerenciadorCalibracao {

    public int calcularValoresDeCalibracao(String caminhoArquivo) throws IOException, InterruptedException {
        List<String> linhas = LeitorArquivo.lerLinhas(caminhoArquivo);
